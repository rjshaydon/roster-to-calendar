...
// an exact old-event identity allow-list, tied to one immutable retained source
// file; it is not a general permission to remove calendar events.  The listed
// events are either the agreed Dandenong allocation annotations or obsolete
// whole-week leave rows which the shared parser replaces with the actual leave
// days plus rostered shifts.
