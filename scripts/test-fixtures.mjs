...
assert.match(d1CalendarSource, /export async function queryFacilityOverviewOnShift[\s\S]*return applyFacilityStaffSeniorityOverridesToCoworkerEvents\(db, events\)/, "On shift should resolve placeholder grades using the same effective-grade logic as Who");
