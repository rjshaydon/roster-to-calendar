...
assert.match(styleSource, /\.facility-overview-on-shift-names > div \{[\s\S]*width: 100%;[\s\S]*\}[\s\S]*\.facility-overview-contact-number \{[\s\S]*margin-left: auto;/, "On shift cards should keep grades before and phone numbers right-aligned");
