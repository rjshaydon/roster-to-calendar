...
assert.match(stateSource, /facilityOverviewSubject[\s\S]*materializedOnly: materializedAccessFor\(account\.record, facilityOverviewSubject\.record\)/, "At a glance handlers must scope compact access to the actor and viewed subject");
