...
| VHH cached-reader canary, 24 Sep 2026 at 19:17 AEST | The Creator confirmed that VHH appeared in At a glance and that both VHH On shift and ED Staff loaded successfully without an observable error. MMC, DDH, MCH and VHH cached readers remain enabled; publication/bootstrap controls, contacts, automatic launch and legacy SQL remain closed. |
